...
Chef::Config[:ec2_flavor_info].merge!({
    ...
    't2.micro'    => { :price => 0.013, :bits => 64, :ram =>   1024, :cores => 1, :core_size => 0.25, :inst_disks => 0, :inst_disk_size =>    0, :ephemeral_volumes => 0 },
    't2.small'    => { :price => 0.026, :bits => 64, :ram =>   2048, :cores => 1, :core_size => 0.25, :inst_disks => 0, :inst_disk_size =>    0, :ephemeral_volumes => 0 },
    't2.medium'   => { :price => 0.053, :bits => 64, :ram =>   4096, :cores => 1, :core_size => 0.25, :inst_disks => 0, :inst_disk_size =>    0, :ephemeral_volumes => 0 },
    'm1.small'    => { :price => 0.044, :bits => 64, :ram =>   1740, :cores => 1, :core_size => 1,    :inst_disks => 1, :inst_disk_size =>  160, :ephemeral_volumes => 1 },
    'm1.medium'   => { :price => 0.087, :bits => 64, :ram =>   3840, :cores => 2, :core_size => 1,    :inst_disks => 1, :inst_disk_size =>  410, :ephemeral_volumes => 1 },
    ...
    'm1.large'    => { :price => 0.175, :bits => 64, :ram =>   7680, :cores => 2, :core_size => 2,    :inst_disks => 2, :inst_disk_size =>  850, :ephemeral_volumes => 2, :ebs_optimizable =>  500, },
    ...
    'm1.xlarge'   => { :price => 0.35,  :bits => 64, :ram =>  15360, :cores => 4, :core_size => 2,    :inst_disks => 4, :inst_disk_size => 1690, :ephemeral_volumes => 4, :ebs_optimizable => 1000, },
    ...
    'r3.large'    =>  { :price => 0.175,:bits => 64, :ram =>  15360, :cores => 2, :core_size => 5.50, :inst_disks => 1, :inst_disk_size =>   32, :ephemeral_volumes => 1, :placement_groupable => true, :virtualization => 'hvm' },
    'r3.xlarge'   =>  { :price => 0.35, :bits => 64, :ram =>  30720, :cores => 4, :core_size => 5.50, :inst_disks => 1, :inst_disk_size =>   80, :ephemeral_volumes => 1, :placement_groupable => true, :virtualization => 'hvm', :ebs_optimizable => 1000 },
    'r3.2xlarge'  =>  { :price => 0.70, :bits => 64, :ram =>  62464, :cores => 8, :core_size => 5.50, :inst_disks => 1, :inst_disk_size =>  160, :ephemeral_volumes => 1, :placement_groupable => true, :virtualization => 'hvm', :ebs_optimizable => 1000 },
    'r3.4xlarge'  =>  { :price => 1.40, :bits => 64, :ram => 124928, :cores =>16, :core_size => 5.50, :inst_disks => 1, :inst_disk_size =>  320, :ephemeral_volumes => 1, :placement_groupable => true, :virtualization => 'hvm', :ebs_optimizable => 1000 },
    'r3.8xlarge'  =>  { :price => 2.80, :bits => 64, :ram => 249856, :cores =>32, :core_size => 5.50, :inst_disks => 2, :inst_disk_size =>  320, :ephemeral_volumes => 1, :placement_groupable => true, :virtualization => 'hvm' },
