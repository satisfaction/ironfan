...
Chef::Config[:ec2_flavor_info].merge!({
    ...
    'c3.large'    =>  { :price => 0.15, :bits => 64, :ram =>   3840, :cores => 2, :core_size => 6.50, :inst_disks => 2, :inst_disk_size =>   16, :ephemeral_volumes => 2, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
    'c3.xlarge'   =>  { :price => 0.30, :bits => 64, :ram =>   7168, :cores => 4, :core_size => 6.50, :inst_disks => 2, :inst_disk_size =>   40, :ephemeral_volumes => 2, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
    'c3.2xlarge'  =>  { :price => 0.60, :bits => 64, :ram =>  15360, :cores => 8, :core_size => 6.50, :inst_disks => 2, :inst_disk_size =>   80, :ephemeral_volumes => 2, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
    'c3.4xlarge'  =>  { :price => 1.20, :bits => 64, :ram =>  30720, :cores =>16, :core_size => 6.50, :inst_disks => 2, :inst_disk_size =>  160, :ephemeral_volumes => 2, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
    'c3.8xlarge'  =>  { :price => 2.40, :bits => 64, :ram =>  30720, :cores =>32, :core_size => 6.50, :inst_disks => 2, :inst_disk_size =>  320, :ephemeral_volumes => 2, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
    'hs1.8xlarge' =>  { :price => 4.60, :bits => 64, :ram => 119808, :cores => 8, :core_size => 5.50, :inst_disks =>24, :inst_disk_size => 2048, :ephemeral_volumes =>24, :placement_groupable => true, :virtualization => 'hvm', :ebs_opizable => 10000 },
  })
