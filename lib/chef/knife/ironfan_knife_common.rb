#
#   Portions Copyright (c) 2012 VMware, Inc.
#   Portions Copyright (c) 2012 VMware, Inc.
...
module Ironfan
  module KnifeCommon
    ...
    def load_ironfan
      ...
      if config[:vsphere] # for :vsphere cloud
        require 'ironfan/monitor'
        extend Ironfan::Monitor

        require 'ironfan/vsphere/broker'
        initialize_ironfan_broker(config[:from_file]) if config[:from_file]
      end
    end
